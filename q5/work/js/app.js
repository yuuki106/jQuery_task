$(function () {
  ...
  $(".dropdwn > li").hover(
    ...
    function () {
      let dropdwnIndex = $(this).index();// 現在カーソルが乗っているdropdwnのindex番号をdropdwnIndexに代入。
    ...
    function () {
      let dropdwnIndex = $(this).index();//現在カーソルが乗っているdropdwnのindex番号をdropdwnIndexに代入。※スコープの関係で再度dropdwnIndexに代入。
